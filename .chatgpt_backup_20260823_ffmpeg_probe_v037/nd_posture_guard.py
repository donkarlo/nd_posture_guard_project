...
class NdPostureGuard:
    ...
    def run(self) -> int:
        ...
        from nd_posture_guard.application.ffmpeg_capture_posture_guard_application import (
            FfmpegCapturePostureGuardApplication,
        )

        application = FfmpegCapturePostureGuardApplication(self._settings_path)
