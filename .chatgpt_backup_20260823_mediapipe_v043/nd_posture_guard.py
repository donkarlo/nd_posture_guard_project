...
class NdPostureGuard:
    ...
    def run(self) -> int:
        ...
        from nd_posture_guard.application.restored_camera_posture_guard_application import (
            RestoredCameraPostureGuardApplication,
        )

        application = RestoredCameraPostureGuardApplication(self._settings_path)
