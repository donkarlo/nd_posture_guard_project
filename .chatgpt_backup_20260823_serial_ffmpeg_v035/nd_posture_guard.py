...
class NdPostureGuard:
    ...
    def run(self) -> int:
        ...
        from nd_posture_guard.application.isolated_posture_guard_application import (
            IsolatedPostureGuardApplication,
        )

        application = IsolatedPostureGuardApplication(self._settings_path)
