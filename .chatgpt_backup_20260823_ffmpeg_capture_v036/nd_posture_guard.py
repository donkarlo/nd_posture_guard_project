...
class NdPostureGuard:
    ...
    def run(self) -> int:
        ...
        from nd_posture_guard.application.serialized_posture_guard_application import (
            SerializedPostureGuardApplication,
        )

        application = SerializedPostureGuardApplication(self._settings_path)
