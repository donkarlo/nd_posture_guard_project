...
class MediaPipeDetectedTrainingDatasetRepository(
    ...
    """Rebuild profile features from each saved anchor using fresh MediaPipe detections."""

    def __init__(self, *args, model_dir: Path, **kwargs) -> None:
    ...
    def build_profile(
        ...
        with self._repository_lock:
            ...
            detector = MediaPipePostureGeometryDetector(self._model_dir)
            try:
