...
from nd_posture_guard.camera.probed_ffmpeg_camera_device_finder import (
    ProbedFfmpegCameraDeviceFinder,
)
from nd_posture_guard.camera.probed_ffmpeg_camera_reader import ProbedFfmpegCameraReader
...
class InstantSnapshotPostureGuardApplication:
    """Compose the probed ffmpeg camera with immediate-snapshot training."""
    ...
    def __init__(self, settings_path: Path) -> None:
        ...
        camera_device, camera_input_format = ProbedFfmpegCameraDeviceFinder(
        ...
        worker = InstantSnapshotMonitoringWorker(
            camera=ProbedFfmpegCameraReader(
                camera_device,
                camera_input_format,
