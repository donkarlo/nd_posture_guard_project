...
class IsolatedPostureGuardApplication:
    """Compose camera, UI, persistence and tracking with blocking domains isolated."""
    ...
    def __init__(self, settings_path: Path) -> None:
        ...
        dataset_repository = IsolatedTrainingDatasetRepository(
