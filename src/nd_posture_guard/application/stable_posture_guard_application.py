...
from nd_posture_guard.data.stable_training_dataset_repository import StableTrainingDatasetRepository
...
class StablePostureGuardApplication:
    """Compose the stable Linux camera path, training store, tracker and UI."""
    ...
    def __init__(self, settings_path: Path) -> None:
        ...
        dataset_repository = StableTrainingDatasetRepository(
        ...
        worker = StableMonitoringWorker(
            camera=StableCameraReader(
                camera_device,
