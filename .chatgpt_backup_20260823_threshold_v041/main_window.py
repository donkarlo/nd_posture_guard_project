...
class MainWindow(QMainWindow):
    ...
    def __init__(self, title: str, bad_score_threshold: float, data_root: str) -> None:
        ...
        self._cancel_training_button = QPushButton("Cancel training")
        self._cancel_training_button.setEnabled(False)
        self._cancel_training_button.clicked.connect(self.training_cancel_requested.emit)
        ...
        controls.addWidget(self._cancel_training_button)
