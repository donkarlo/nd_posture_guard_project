...
class NdPostureGuard:
    ...
    def run(self) -> int:
        ...
        from nd_posture_guard.application.stable_posture_guard_application import (
            StablePostureGuardApplication,
        )

        application = StablePostureGuardApplication(self._settings_path)
