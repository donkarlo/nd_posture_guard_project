...
class NdPostureGuard:
    ...
    def run(self) -> int:
        ...
        from nd_posture_guard.application.instant_snapshot_posture_guard_application import (
            InstantSnapshotPostureGuardApplication,
        )

        application = InstantSnapshotPostureGuardApplication(self._settings_path)
